...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">SUNRISE.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>083169760930</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SUNRISE <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dream Will Real</p></a></h1>
				</div>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>SUNRISE HOTEL</h4>
									<h3>We Will Making Comfortable For You</h3>
										<p>Welcome to SUNRISE HOTEL</p>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>SUNRISE HOTEL</h4>
									<h3>Stay with couple & friends</h3>
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>Your comfortable is number one, enjoy your moment</span> Find our couple welcoming reception</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">PLATINUM BEDROOM QUALITY</h4>
							<span class="cbp-ig-category">SUNRISE HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">LARGE RESTO</h4>
							<span class="cbp-ig-category">SUNRISE HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SUNRISE PRIDE</span>
						</div>
					</li>
				</ul>
			</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our RISE</h3> 
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Meet Our family</h3>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>083169760930</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">HOTEL@RISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Bandung jawa barat indonesia</p>
			...
			<iframe src="https://www.google.com/maps/place/Bandung,+Kota+Bandung,+Jawa+Barat/@-6.9032739,107.5731165,12z/data=!3m1!4b1!4m5!3m4!1s0x2e68e6398252477f:0x146a1f93d3e815b2!8m2!3d-6.9174639!4d107.6191228" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2011 RISE . All Rights Reserved | Design by <a href="index.php">SUNRISE HOTEL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
